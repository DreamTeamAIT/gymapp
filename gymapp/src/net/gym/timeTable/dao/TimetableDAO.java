...
public class TimetableDAO implements ITimetableDAO {
    ...
    public void insertTimetable(TimeTable timetable) throws SQLException {
        ...
        try (Connection connection = JDBCUtils.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(INSERT_TIMETABLE_SQL)) {
    ...
    public boolean deleteTimetable(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = JDBCUtils.getConnection(); PreparedStatement statement = connection.prepareStatement(DELETE_TIMETABLE_BY_ID);) {
    ...
    public boolean updateTimetable(TimeTable timetable) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = JDBCUtils.getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_TIMETABLE);) {
   ...
   /*         statement.setDate(4, JDBCUtils.getSQLDate(todo.getTargetDate()));
            statement.setBoolean(5, timetable.getStatus());*/
